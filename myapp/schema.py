...
class Mutation(graphene.ObjectType):
    ...
    send_message = MessageFromUser.Field()
    delete_message = DeleteMessage.Field()
    reset_password = ResetPassword.Field()
    github_oauth  = GitHubOAuthMutation.Field()


class Query(CategoryQuery, EventQuery, UserProfileQuery, EventCountQuery, EventApplicationQuery, EventUserQuery, RoomQuery, UserQuery, MessageQuery, MessageCountQuery, ProductQuery, graphene.ObjectType):
    pass
